...
from backend.app.database import DatabaseConfigurationError, check_database_connection
from backend.app.errors import ApiError
from backend.app.profile_routes import router as profile_router
from backend.app.chat.router import messages_router
from backend.app.trip.router import trips_router, users_router
...
async def trip_domain_error_handler(request: Request, error: AppError) -> JSONResponse:
...
async def request_validation_error_handler(
    ...
    if not request.url.path.startswith(("/auth/", "/profile")):
